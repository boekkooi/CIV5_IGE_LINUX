...
-------------------------------------------------------------------------------------------------
function IGEAddPopupText( worldPosition, text, delay )
    local instance = g_PopupIM:GetInstance();
    instance.Anchor:SetWorldPosition( worldPosition );
    instance.Text:SetText( text );
    instance.AlphaAnimOut:RegisterAnimCallback( IGEKillPopupText );
...
--Events.AddPopupTextEvent.Add( IGEAddPopupText );

-------------------------------------------------------------------------------------------------
function IGEKillPopupText( control )
...
-------------------------------------------------------------------------------------------------
function IGEOnGameplayAlertMessage( text )
	local newAlert = {};
	newAlert.text = text;
...
--Events.GameplayAlertMessage.Add( IGEOnGameplayAlertMessage );
LuaEvents.IGE_FloatingMessage.Add(IGEOnGameplayAlertMessage)

-------------------------------------------------------------------------------------------------
function IGEOnUpdate(fDTime)
...
ContextPtr:SetUpdate( IGEOnUpdate );
