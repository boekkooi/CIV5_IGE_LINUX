...
-------------------------------------------------
-------------------------------------------------
function IGEGenericLeftClick( Id )
...
-------------------------------------------------
-------------------------------------------------
function IGEGenericRightClick ( Id )
...
------------------------------------------------------------------------------------
Controls[ "TechButton" ]:RegisterCallback( Mouse.eLClick, IGEGenericLeftClick );
Controls[ "TechButton" ]:RegisterCallback( Mouse.eRClick, IGEGenericRightClick );
Controls[ "ProductionButton" ]:RegisterCallback( Mouse.eLClick, IGEGenericLeftClick );
Controls[ "ProductionButton" ]:RegisterCallback( Mouse.eRClick, IGEGenericRightClick );
Controls[ "FreeTechButton" ]:RegisterCallback( Mouse.eLClick, IGEGenericLeftClick );
Controls[ "FreeTechButton" ]:RegisterCallback( Mouse.eRClick, IGEGenericRightClick );
Controls[ "FreePolicyButton" ]:RegisterCallback( Mouse.eLClick, IGEGenericLeftClick );
Controls[ "FreePolicyButton" ]:RegisterCallback( Mouse.eRClick, IGEGenericRightClick );
Controls[ "FreeGreatPersonButton" ]:RegisterCallback( Mouse.eLClick, IGEGenericLeftClick );
Controls[ "FreeGreatPersonButton" ]:RegisterCallback( Mouse.eRClick, IGEGenericRightClick );
...
function IGEOnNotificationAdded( Id, type, toolTip, strSummary, iGameValue, iExtraGameData )
    ...
    button:SetVoid1( Id );
    button:RegisterCallback( Mouse.eLClick, IGEGenericLeftClick );
    button:RegisterCallback( Mouse.eRClick, IGEGenericRightClick );
--    title:SetText( name );
--    text:SetText( toolTip );
    ...
    IGEProcessStackSizes();

end

-------------------------------------------------------------------------------------------------
function IGERemoveNotificationID( Id )
...
-------------------------------------------------------------------------------------------------
function IGENotificationRemoved( Id )
	--print("removed notification: "..getstr(Id));
	IGERemoveNotificationID( Id );	
    IGEProcessStackSizes();
end

-------------------------------------------------------------------------------------------------
function IGEOnNotificationPanelActivePlayerChanged( iActivePlayer, iPrevActivePlayer )
	...
	for thisID, thisType in pairs(g_ActiveNotifications) do
		IGERemoveNotificationID(thisID);
	end

end

-------------------------------------------------------------------------------------------------
function IGEProcessStackSizes()
...
local function IGEOnShowing()
	...
	Events.NotificationRemoved.Add(IGENotificationRemoved);
	Events.GameplaySetActivePlayer.Add(IGEOnNotificationPanelActivePlayerChanged);

	IGEOnNotificationPanelActivePlayerChanged()
...
local function IGEOnClosing()
	Events.NotificationAdded.Remove(IGEOnNotificationAdded);
	Events.NotificationRemoved.Remove(IGENotificationRemoved);
	Events.GameplaySetActivePlayer.Remove(IGEOnNotificationPanelActivePlayerChanged);
end
