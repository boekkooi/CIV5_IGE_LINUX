...
-------------------------------------------------------------------------------------------------
function IGEOnPopupMessage(player)
	g_player = player;
   	UIManager:QueuePopup( ContextPtr, PopupPriority.SocialPolicy );
end
LuaEvents.IGE_ChoosePantheonPopup.Add(IGEOnPopupMessage);
...
function IGERefreshList()
	...
	for i, pantheon in ipairs(availablePantheonBeliefs) do
		...
		itemInstance.Button:RegisterCallback(Mouse.eLClick, function() IGESelectPantheon(pantheon.ID); end);
...
-------------------------------------------------------------------------------------------------
function IGESelectPantheon(beliefID) 
	g_BeliefID = beliefID;
